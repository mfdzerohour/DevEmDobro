...
function trocarCor() {
    ...
    //Poderia ser substituida por Toggle, método adiciona a 
    // classe se ela não existir e remove se existir
    // quadradoAzul.classList.toggle("azul");
    // quadradoAzul.classList.toggle("amarelo");
}