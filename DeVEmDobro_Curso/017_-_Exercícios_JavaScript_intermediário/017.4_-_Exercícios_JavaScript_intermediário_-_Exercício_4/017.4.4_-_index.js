...
// Passo 2 - Dar um jeito de percorrer todos os inputs com a classe input-text. - vamos utilizar o laço de repetição forEach para percorrer todos os inputs com as classes input-text.
